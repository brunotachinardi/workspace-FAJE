package com.eguru.faje {
	 ...
	 */
	public class FajeContext extends Context 
	{
		public function FajeContext(contextView : DisplayObjectContainer) 
		{
		...
		override public function startup():void
        {
			...
			contextView.addChild(new StageManagerView());
